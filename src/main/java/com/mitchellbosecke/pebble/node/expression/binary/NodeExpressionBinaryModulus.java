...
public class NodeExpressionBinaryModulus extends NodeExpressionBinary {

	@Override
	public void compile(Compiler compiler) {
		compiler.raw(OperatorUtils.class.getName()).raw(".mod(").subcompile(getLeftExpression(), false).raw(",")
