...
public class NodeExpressionBinaryAdd extends NodeExpressionBinary {

	@Override
	public void compile(Compiler compiler) {
		compiler.raw(OperatorUtils.class.getName()).raw(".add(").subcompile(getLeftExpression(), false).raw(",")
