...
public class PebbleEngine {
    ...
    private final boolean globalScoping;
    ...
    private PebbleEngine(Loader<?> loader,
        ...
        this.globalScoping = globalScoping;
    ...
    /**
     * Returns the global scoping setting
     *
     * @return The global scoping setting
     */
    public boolean isGlobalScoping() {
    ...
    public static class Builder {
        ...
        private boolean globalScoping = false;
        ...
        /**
         * Changes the <code>globalScoping</code> setting of the PebbleEngine. The default value of this setting is "false".
         * <p>This setting allows accessing a {@link com.mitchellbosecke.pebble.template.EvaluationContext context's}
         * {@link com.mitchellbosecke.pebble.template.ScopeChain} from anywhere within a template (including macros),
         * regardless of each {@link com.mitchellbosecke.pebble.template.Scope scope's} locality.</p>
         *
         * @param globalScoping Whether or not the scope chain is accessible globally.
         * @return This builder object
         */
        public Builder globalScoping(boolean globalScoping) {
            this.globalScoping = globalScoping;
            return this;
        }
    ...
    public Builder greedyMatchMethod(boolean greedyMatchMethod) {
      ...
      return this;
        ...
        public PebbleEngine build() {
            ...
            return new PebbleEngine(this.loader, this.syntax, this.strictVariables, this.globalScoping, this.defaultLocale, this.maxRenderedSize,
