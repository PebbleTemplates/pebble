...
| `allowUnsafeMethods` | If set to false, Pebble will throw an exception if you try to access unsafe methods. Unsafe methods are all methods of classes: `java.lang.Class`, `java.lang.Runtime`, `java.lang.System`, `java.lang.Thread`, `java.lang.ThreadGroup`, `java.lang.reflect.AccessibleObject` as well as the following methods of class `java.lang.Object`: `getClass`, `wait`, `notify`, `notifyAll` | `true` in 2.x, 'false' in v3.x |
